...
# Add HDL sources
add_files -fileset sources_1 ./src/addr_gen/addr_gen.sv

add_files -fileset sources_1 ./src/csr/axil2reg_wr.sv
add_files -fileset sources_1 ./src/csr/sa_csr.sv

add_files -fileset sources_1 ./src/flow_ctl/credit_cnt.sv
add_files -fileset sources_1 ./src/flow_ctl/fifo.sv
add_files -fileset sources_1 ./src/flow_ctl/rf_1r1w.sv

add_files -fileset sources_1 ./src/sa/pe.sv
add_files -fileset sources_1 ./src/sa/sa_core.sv
add_files -fileset sources_1 ./src/sa/sa_top.sv
add_files -fileset sources_1 ./src/sa/sr.sv

add_files -fileset sources_1 ./src/sa_flow_ctl.sv
# Top module
add_files -fileset sources_1 ./src/axi_sa_top.v
...
create_bd_cell -type module -reference axi_sa_top axi_sa_top_0

set_property -dict [list \
  CONFIG.WIDTH {16} \
  CONFIG.FIFO_STAGES {8} \
  CONFIG.AXI_ADDR_WIDTH {32} \
] [get_bd_cells axi_sa_top_0]
...
connect_bd_net [get_bd_pins axi_sa_top_0/clk]               [get_bd_pins processing_system7_0/FCLK_CLK0]
...
connect_bd_net [get_bd_pins proc_sys_reset_0/peripheral_aresetn] [get_bd_pins axi_sa_top_0/rst_n]
...
connect_bd_net [get_bd_pins axi_sa_top_0/o_irq]                  [get_bd_pins processing_system7_0/IRQ_F2P]

connect_bd_intf_net [get_bd_intf_pins smartconnect_0/M00_AXI]         [get_bd_intf_pins processing_system7_0/S_AXI_HP0]
connect_bd_intf_net [get_bd_intf_pins axi_sa_top_0/m_axi]             [get_bd_intf_pins smartconnect_0/S00_AXI]
connect_bd_intf_net [get_bd_intf_pins processing_system7_0/M_AXI_GP0] [get_bd_intf_pins axi_protocol_convert_0/S_AXI]
connect_bd_intf_net [get_bd_intf_pins axi_protocol_convert_0/M_AXI]   [get_bd_intf_pins axi_sa_top_0/S_AXIL]
