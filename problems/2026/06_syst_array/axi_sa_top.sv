module axi_sa_top #(
    ...
    input  logic [AXIL_DATA_WIDTH / 8 - 1:0] s_axil_wstrb, // STRB_WIDTH = DATA_WIDTH / 8
...
// csr store address of matrices with AXI_ADDR_WIDTH bits len
...
logic csr_start_sgnl;
logic csr_is_b;
logic [AXI_ADDR_WIDTH - 1:0] csr_ab_addr;
logic [AXI_ADDR_WIDTH - 1:0] csr_c_addr;

// store addresses of A, B, C
sa_csr #(.ADDR_WIDTH(AXIL_ADDR_WIDTH),
